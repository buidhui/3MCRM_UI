            ...
            <div>
                ...
                <Row>
                    <Col xl={7}>
                        <Card className="detail-card" style={{ width: '100%' }}>
                            <Card.Body>
                                ...
                                <Row>
                                    <Col >
                                        <Card.Subtitle className="cus-sub"><h6>Tên nhóm</h6></Card.Subtitle>
                                        <Card.Text className="cus-note">
                                            {(groupDetail.name) ? groupDetail.name : "Đang cập nhật"}
                                        </Card.Text>
                                    </Col>
                                    <Col >
                                        <Card.Subtitle className="cus-sub"><h6>Mã nhóm</h6></Card.Subtitle>
                                        <Card.Text className="cus-note">
                        ...
                        <Card className="detail-card" style={{ width: '100%' }}>
                            <Card.Body>
                                ...
                                <Row>
                                    ...
                                    <Col >
                                        <Card.Subtitle className="cus-sub"><h6>Số lượng khách hàng </h6></Card.Subtitle>
                                        <Card.Text className="cus-note">
                    ...
                    <Col xl={5}>
                        <Card className="detail-card" style={{ width: '100%' }}>
                            <Card.Body>
                                <Card.Title>Thông tin phụ</Card.Title>
                                <Row>
                                    <Col>
                                        <Card.Subtitle className="cus-sub"><h6>Mô tả nhóm khách hàng</h6></Card.Subtitle>
                                        <Card.Text className="cus-note">
