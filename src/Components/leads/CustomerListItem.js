...
class CustomerListItem extends Component{
    ...
    render(){
        ...
        return(
            <tr> 
                <td  style={{display: "table-cell", verticalAlign: "middle",width: "15%"}} >{customer.name}</td>
                ...
                <td  style={{display: "table-cell", verticalAlign: "middle", width: "10%"}} className="text-center  " >{(customer.opportunity === 0) ? "Đầu mối" : "Tiềm năng" }</td>
