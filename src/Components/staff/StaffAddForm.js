              ...
              <Col xs={8} className="add-col">
                <Container className="add-form">
                    <Form.Row className="add-form-row">
                      ...
                      <Form.Control type="text" name="name" value={this.state.name} placeholder="Nhập tên nhân viên" onChange={this.onChange}/>
                      </Form.Group>
              ...
              <Container className="add-form">
                <Form.Row className="add-form-row" >
                  <Form.Group as={Col} controlId="formGridName">
                    ...
                    <Form.Control as="textarea" rows="5" name="note" value={this.state.note} placeholder="Nhập mô tả về nhân viên" onChange={this.onChange}/>
                  </Form.Group>                 
                </Form.Row>                                                   
                </Container> 
              </Col>                     
