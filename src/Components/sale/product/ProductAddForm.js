          ...
          <Form>
            ...
            <Row>
              <Col xs={8} className="add-col">
                ...
                <Container className="add-form">
                  <h5 className="add-product-h6">
                    Giá sản phẩm <span style={{ color: "red" }}>*</span>
                  </h5>
                  <Form.Row className="add-form-row">
                    <Form.Group as={Col} controlId="formGridEmail">
                      <Form.Label>
                        Giá bán lẻ <span style={{ color: "red" }}>*</span>
                      </Form.Label>
                      <Form.Control
                        type="number"
                        name="gia_xuatle"
                        value={this.state.gia_xuatle}
                    ...
                    <Form.Group as={Col} controlId="formGridPhone">
                      <Form.Label>
                        Giá bán buôn <span style={{ color: "red" }}>*</span>
                      </Form.Label>
                      <Form.Control
                        type="number"
                        name="gia_xuatbuon"
                        value={this.state.gia_xuatbuon}
                  ...
                  <Form.Row className="add-form-row">
                    ...
                    <Form.Group as={Col} controlId="formGridPhone">
                      ...
                      <Form.Control
                        ...
                        placeholder="Nhập thuể của sản phẩm"
                        onChange={this.onChange}
                      />
                    </Form.Group>
                  </Form.Row>
                  ...
                  <Form.Row className="add-form-row">
                    <Form.Group as={Col} controlId="formGridEmail">
                      ...
                      <Form.Control
                        ...
                        placeholder="Nhập hàng còn trong kho"
                        onChange={this.onChange}
                      />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formGridPhone">
                      ...
                      <Form.Control
                        type="text"
                        name="don_vi"
                        value={this.state.don_vi}
                        placeholder="(Chiếc, cái ....)"
                        onChange={this.onChange}
                      />
                    </Form.Group>
                  </Form.Row>
